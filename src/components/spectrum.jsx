  ...
  return (
    <>
      <div className="relative">
        <div className="bg-[#00000086] block md:hidden inset-0 absolute w-full h-full top-0 left-0 z-4"></div>
        <div
            ...
            <div className="flex flex-col md:items-end relative z-5">
              <div className="font-inter text-white flex flex-col md:items-end max-w-[500px] justify-end">
                ...
                <p className="font-inter text-[18px] font-[500] mt-[100px]">
                  ...
                  высокопрофессиональное отношение к делу являются отправной
                  точкой для успешной реализации проектов.
                </p>
              </div>
